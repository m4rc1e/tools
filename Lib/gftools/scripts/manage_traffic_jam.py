        ...
        if item:
            ...
            if push_item.category in [PushCategory.UPGRADE, PushCategory.NEW]:
                res.update({
                    ...
                    **push_item.__dict__,
                    **{
                        "dev url": "https://fonts-dev.sandbox.google.com/specimen/{}".format(item.name.replace(" ", "+")),
                        "sandbox url": "https://fonts.sandbox.google.com/specimen/{}".format(item.name.replace(" ", "+")),
                        "prod url": "https://fonts.google.com/specimen/{}".format(item.name.replace(" ", "+")),
                    }
                })
            else:
